...
class MyCall {
	...
	* File : run.php
	* Author : DILLZY
	* Github : https://github.com/DILLZY
	* Date : 27-11-2021
	* Note : Jngan Recode Anjing
	* Version : 1.0
	*/
